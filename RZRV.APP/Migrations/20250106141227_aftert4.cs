...
{
    public partial class aftert4 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReferredByServiceProviderId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Customer_ServiceProvider_ReferredByServiceProviderId",
                        column: x => x.ReferredByServiceProviderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_ReferredByServiceProviderId",
                table: "Customer",
                column: "ReferredByServiceProviderId");
